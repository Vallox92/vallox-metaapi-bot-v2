...
// Reemplaza por tu token y accountId real
...
app.post('/webhook', async (req, res) => {
  try {
    ...
    const trade = await account.getTradeApi();
    console.log('🚀 Ejecutando orden...');

    await trade.createMarketOrder(symbol, type, 0.01, {
      sl: 500, // 50 pips
      tp: 1000 // 100 pips
    });

    console.log(`🎯 Orden de ${type} ejecutada correctamente en ${symbol}`);
