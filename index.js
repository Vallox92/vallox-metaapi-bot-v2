...
app.post('/webhook', async (req, res) => {
  try {
    ...
    // Esperar hasta que la cuenta esté conectada
    ...
    let order = {
      ...
      magic: 123456,
      sl: type === 'buy' ? price.ask - slPips * 0.01 : price.bid + slPips * 0.01,
      tp: type === 'buy' ? price.ask + tpPips * 0.01 : price.bid - tpPips * 0.01
    };

    const result = await connection.createOrder(order);
